...
void read_cards(int hand_ranks[], int hand_suits[]);
void analyze_hand(int hand_ranks[], int hand_suits[]);
...
int main(void) {
  ...
  while (true) {
    read_cards(hand_ranks, hand_suits);
    analyze_hand(hand_ranks, hand_suits);
    print_result();
  }
